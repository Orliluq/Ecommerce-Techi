        ...
        <>
                ...
                >
                  <div className="left flex col-span-2 gap-5 md:col-span-2">
                    ...
                    <div className="details flex flex-col gap-3 items-start">
                      ...
                      <button
                        ...
                        className="uppercase text-blue-400 hover:text-rose-400 duration-300"
                      >
                        Remove
                      </button>
                    </div>
                  ...
                  <div className="counter flex">
                    <button
                      ...
                      className="h-8 md:h-10 w-8 md:w-10 bg-blue-100 border border-gray-300 active:bg-gray-700 "
                    >
                      -
                    </button>
                    <span className="h-8 md:h-10 w-8 md:w-10bg-blue-100 flex justify-center items-center border border-gray-300 ">
                      {" "}
          ...
          <div className="cart-lower flex flex-col-reverse items-center gap-10 md:flex-row md:justify-between md:items-start md:gap-0 py-10 px-5 md:px-0">
            <button
              ...
              className="clear-btn uppercase border py-3 px-8 hover:bg-red-200 hover:text-rose-600 font-medium text-sm md:text-lg hover:border-rose-200 duration-300"
            >
              Clear cart
            </button>
            <div className="flex flex-col items-start gap-2">
              ...
              <p className="text-orange-400 text-sm md:text-lg text-justify">
