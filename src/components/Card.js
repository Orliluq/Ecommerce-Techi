  ...
  return (
    <div className="product flex flex-col gap-2 bg-white shadow-md rounded-xl overflow-hidden hover:shadow-2xl duration-300">
      ...
      <div className="texts flex flex-col gap-2 px-5 pb-5">
        ...
        <p className="details text-green-500 h-[6rem]"> {product.description}</p>
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="uppercase bg-blue-500 text-blue-50 font-medium py-3 px-8 rounded-md hover:bg-orange-500 hover:text-orange-50 duration-300 shadow-lg shadow-violet-300 hover:shadow-orange-300"
          >
            Add to cart
          </button>
        </div>
