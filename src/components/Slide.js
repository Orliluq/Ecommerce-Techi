  ...
  return (
    <div className="slide " style={{ backgroundImage: `url(${image.src})` }}>
      <div className="slide-texts container mx-auto flex flex-col items-start justify-center h-full gap-5 text-violet-50">
        <h1 className="text-7xl text-red-50 font-bold space-font w-4/5  uppercase ">
          {image.headline}
        </h1>
        ...
        <Link
          ...
          className="slide-btn uppercase border border-red-50 h-14 w-72 hover:text-orange-60 duration-300 font-medium mt-5"
        >
